...
public class DrugiDoCetvrtogPrviKat implements Initializable {
    Soba soba = new Soba();
    @FXML
    private Button gumb1, gumb2, gumb3, gumb4, gumb5, gumb6, gumb7, gumb8, gumb9, gumb10;

    private List<Button> getButtons() {
        return Arrays.asList(gumb1, gumb2, gumb3, gumb4, gumb5, gumb6, gumb7, gumb8, gumb9, gumb10);
    }
    private boolean isOneBedRoom(int brojSobe) {
        int lastTwoDigits = brojSobe % 100;
        return lastTwoDigits == 5 || lastTwoDigits == 6;
    }
