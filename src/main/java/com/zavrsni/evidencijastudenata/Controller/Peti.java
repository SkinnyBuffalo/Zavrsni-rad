...
public class Peti implements Initializable {
    Soba soba = new Soba();
    @FXML
    private Button gumb1, gumb2, gumb3, gumb4, gumb5, gumb6, gumb7, gumb8, gumb9, gumb10, gumb11, gumb12, gumb13, gumb14, gumb15, gumb16, gumb17;

    private List<Button> getButtons() {
        return Arrays.asList(gumb1, gumb2, gumb3, gumb4, gumb5, gumb6, gumb7, gumb8, gumb9, gumb10, gumb11, gumb12, gumb13, gumb14, gumb15, gumb16, gumb17);
    }
    private boolean isOneBedRoom(int brojSobe) {
        int lastTwoDigits = brojSobe % 100;
        return lastTwoDigits == 3 || lastTwoDigits == 5 || lastTwoDigits == 6 || lastTwoDigits == 11 || lastTwoDigits == 12 || lastTwoDigits == 14;
    }
    ...
    private void openDialog(String buttonText, String buttonColor) {
        try {
            ...
            if(isOneBedRoom(brojSobe) && buttonColor.equals("red")) {
