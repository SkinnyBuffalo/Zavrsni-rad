...
public class DrugiDoCetvrtog implements Initializable {
    Soba soba = new Soba();
    @FXML
    private Button gumb1, gumb2, gumb3, gumb4, gumb5, gumb6, gumb7, gumb8, gumb9, gumb10, gumb11, gumb12;

    private List<Button> getButtons() {
        return Arrays.asList(gumb1, gumb2, gumb3, gumb4, gumb5, gumb6, gumb7, gumb8, gumb9, gumb10, gumb11, gumb12);
    }
    private boolean isOneBedRoom(int brojSobe) {
        int lastTwoDigits = brojSobe % 100;
        return lastTwoDigits == 15 || lastTwoDigits == 16 || lastTwoDigits == 21 || lastTwoDigits == 22|| lastTwoDigits == 33 || lastTwoDigits == 34|| lastTwoDigits == 28 || lastTwoDigits == 27;
    }
